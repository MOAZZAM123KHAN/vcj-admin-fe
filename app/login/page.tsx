...
import { API_BASE, ENDPOINTS } from "@/services/api-client";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const loginEndpoint = `${API_BASE}${ENDPOINTS.LOGIN}`;
      const response = await fetch(loginEndpoint, {
        ...
        body: JSON.stringify({
          mobile: formData.mobile.replace(/\ls+/g, '').replace(/\s/g, '').trim(),
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 bg-transparent">
