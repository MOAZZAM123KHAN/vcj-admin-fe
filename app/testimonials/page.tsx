    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="w-full flex justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 leading-tight">Testimonials & Client Stories</h1>
            <p className="text-gray-500 mt-1">Manage your customer experiences and jewellery journey stories</p>
          </div>
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="treatment">Product / Occasion</Label>
              <Input id="treatment" placeholder="e.g. Bridal Necklace, Wedding Bangles" value={formData.treatment} onChange={(e) => setFormData((prev) => ({ ...prev, treatment: e.target.value }))} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="description">Review Message</Label>
              <Textarea id="description" placeholder="Customer's experience..." value={formData.description} onChange={(e) => setFormData((prev) => ({ ...prev, description: e.target.value }))} />
            </div>
            {/* Links Section */}
            <div className="space-y-2">
