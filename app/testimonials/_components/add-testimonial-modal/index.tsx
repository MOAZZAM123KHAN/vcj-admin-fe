  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Add Client Story</DialogTitle>
          <DialogDescription>Capture a new customer masterpiece testimonial</DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          ...
          <div className="grid w-full items-center gap-2">
            ...
            <Input type="text" id="treatment" placeholder="e.g. Bridal Necklace, Wedding Bangles" value={formData.treatment} onChange={handleInputChange} name="treatment" />
          </div>
          <div className="grid w-full items-center gap-2">
            <Label htmlFor="description">Review Message</Label>
            <Textarea id="description" placeholder="Share the customer's heartfelt feedback..." value={formData.description} onChange={handleInputChange} name="description" />
          </div>
